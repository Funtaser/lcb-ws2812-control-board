...
- [1. 固件功能概述](#1-固件功能概述)
  - [1.1 当前代码支持](#11-当前代码支持)
  - [1.2 当前代码不支持](#12-当前代码不支持)
- [2. 硬件接口说明](#2-硬件接口说明)
  - [2.1 串口接口](#21-串口接口)
  - [2.2 WS2812 灯带接口](#22-ws2812-灯带接口)
  - [2.3 采样接口](#23-采样接口)
  - [2.4 板载状态灯](#24-板载状态灯)
- [3. 串口通信协议](#3-串口通信协议)
  - [3.1 串口参数](#31-串口参数)
  - [3.2 命令格式](#32-命令格式)
  - [3.3 单行长度限制](#33-单行长度限制)
- [4. 上电流程与主控初始化](#4-上电流程与主控初始化)
  - [4.1 控制板上电默认状态](#41-控制板上电默认状态)
  - [4.2 电控推荐初始化流程](#42-电控推荐初始化流程)
  - [4.3 不需要握手的命令](#43-不需要握手的命令)
- [5. 普通命令总表](#5-普通命令总表)
- [6. 普通命令详细说明](#6-普通命令详细说明)
  - [6.1 PING](#61-ping)
  - [6.2 OK](#62-ok)
  - [6.3 STAT](#63-stat)
  - [6.4 COUNT](#64-count)
  ...
  - [6.8 OFF](#68-off)
- [7. 动画说明](#7-动画说明)
  - [7.1 等待主控动画](#71-等待主控动画)
  - [7.2 ANIM 1：红色追逐](#72-anim-1红色追逐)
  - [7.3 ANIM 2：彩虹动画](#73-anim-2彩虹动画)
  - [7.4 ANIM 3：红色呼吸](#74-anim-3红色呼吸)
  - [7.5 ANIM 4：自定义动画](#75-anim-4自定义动画)
- [8. 电压、电流与保护逻辑](#8-电压电流与保护逻辑)
  - [8.1 电压采样](#81-电压采样)
  - [8.2 Type-C / USB 调试供电识别](#82-type-c-usb-调试供电识别)
  - [8.3 电流采样](#83-电流采样)
  - [8.4 故障编号](#84-故障编号)
  - [8.5 故障优先级](#85-故障优先级)
  - [8.6 连续确认与滞回](#86-连续确认与滞回)
- [9. 故障时灯带表现](#9-故障时灯带表现)
- [10. PB3 状态灯说明](#10-pb3-状态灯说明)
- [11. DEV 开发者模式](#11-dev-开发者模式)
  - [11.1 用途](#111-用途)
  - [11.2 自动超时](#112-自动超时)
  - [11.3 DEV 命令总表](#113-dev-命令总表)
  - [11.4 开启 / 关闭开发者模式](#114-开启-关闭开发者模式)
  - [11.5 模拟故障](#115-模拟故障)
  - [11.6 模拟运行状态](#116-模拟运行状态)
  - [11.7 DEV ADC](#117-dev-adc)
  - [11.8 DEV STATUS](#118-dev-status)
- [12. 电控侧推荐状态机](#12-电控侧推荐状态机)
- [13. 电控侧返回值解析建议](#13-电控侧返回值解析建议)
  - [13.1 正常返回](#131-正常返回)
  - [13.2 错误返回](#132-错误返回)
- [14. 常见问题](#14-常见问题)
  - [14.1 发送 COLOR 或 ANIM 返回 ERR NEED_OK](#141-发送-color-或-anim-返回-err-need_ok)
  - [14.2 STAT 返回电压小于 6000，但故障为 0](#142-stat-返回电压小于-6000但故障为-0)
  - [14.3 STAT 中第三字段和第四字段不同](#143-stat-中第三字段和第四字段不同)
  - [14.4 发送 DEV FAULT LOW 返回 ERR DEV OFF](#144-发送-dev-fault-low-返回-err-dev-off)
  - [14.5 灯珠数量较多时灯效异常](#145-灯珠数量较多时灯效异常)
  - [14.6 OK 后灯带没有完全熄灭](#146-ok-后灯带没有完全熄灭)
- [15. 联调测试流程](#15-联调测试流程)
  - [15.1 最小通信测试](#151-最小通信测试)
  - [15.2 握手测试](#152-握手测试)
  - [15.3 基本灯效测试](#153-基本灯效测试)
  - [15.4 动画测试](#154-动画测试)
  - [15.5 状态查询测试](#155-状态查询测试)
  - [15.6 Type-C 调试供电测试](#156-type-c-调试供电测试)
  - [15.7 DEV 故障测试](#157-dev-故障测试)
- [16. 当前版本边界与注意事项](#16-当前版本边界与注意事项)
- [17. 附录：完整命令表](#17-附录完整命令表)
- [18. 电控最简接入示例](#18-电控最简接入示例)
